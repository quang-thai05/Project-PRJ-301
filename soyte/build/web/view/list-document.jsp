                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.document}" var="l">
                                        <tr>
                                            ...
                                            <td>${l.date}</td>
                                            <td><a href="update-document?id=${l.id}" class="btn btn-primary">Update</a>&nbsp &nbsp<a href="delete-document?id=${l.id}" class="btn btn-primary" onclick="return confirm('Are you sure?')">Delete</a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
