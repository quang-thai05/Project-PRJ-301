 ...
 * @author quang
 */
public class AdminDocController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<UserDetail> list2 = udDAO.getUserDetailByRoleId(2);
        List<UserDetail> list3 = udDAO.getUserDetailByRoleId(3);
